...
m = {
    ...
    "F23": "KC_F23",
    "F24": "KC_F24",
    "NEXT_LAYER": "KC_NEXT_LAYER",
    "PREV_LAYER": "KC_PREV_LAYER"
}
...
class MainWindow(Frame):
    ...
    def onFlashClick(self, event=None):
        ...
        if self.masterBoard == "Right":
            ...
            mapping=[k[30], k[34], k[38], k[42], k[47], k[52],
                     k[31], k[35], k[39], k[43], k[48], k[53],
                     k[32], k[36], k[40], k[44], k[49], k[54],
                     k[33], k[37], k[41], k[45], k[50], k[55],
                     k[46], k[51], k[56], k[58], k[57], k[59],

                     k[0], k[4], k[8], k[12], k[17], k[22],
                     k[1], k[5], k[9], k[13], k[18], k[23],
                     k[2], k[6], k[10], k[14], k[19], k[24],
                     k[3], k[7], k[11], k[15], k[20], k[25],
                     k[16], k[21], k[26], k[28], k[27], k[29]]
        ...
        # TODO: make layer logic change layerCount
        layerCount = 3

        if os.name == 'nt': # windows
            f = open("firmware\\src\\mapping.h", "w+")
        elif os.name == 'posix': # linux
            f = open("firmware/src/mapping.h", "w+")
        f.write("#include \"helper.h\"\n")
        f.write("#define LAYER_COUNT " + str(layerCount) + "\n\n")
        f.write("extern const uint8_t mapping[LAYER_COUNT][2 * NUM_IN_PIN][NUM_OUT_PIN];")
        ...
        f.write("const uint8_t mapping[LAYER_COUNT][2*NUM_IN_PIN][NUM_OUT_PIN] = {")
